CLASS zcl_i_where_used_class DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PROTECTED SECTION.
  PRIVATE SECTION.
     METHODS get_where_used_list_for_method
      IMPORTING
        method        TYPE string
        class         TYPE string
      RETURNING
...
CLASS zcl_i_where_used_class IMPLEMENTATION.
  METHOD zif_i_where_used~get_cross_references.
      result = get_where_used_list_for_method( class =  object  method = subobject  ) .
  ENDMETHOD.


  METHOD get_where_used_list_for_method.
